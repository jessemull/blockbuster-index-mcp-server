...
export function calculateWorkforceNormalizedPositiveScores(
  ...
  for (const [state, jobCount] of Object.entries(jobCounts)) {
    ...
    if (workforceSize > 0) {
      /**
       * 1. Calculate percentage of workforce that Walmart technology jobs represent.
...
export default calculateWorkforceNormalizedPositiveScores;
